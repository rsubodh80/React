...
export default function Footer() {
  ...
  return (
    <motion.footer
      ...
      className="bg-gradient-to-tr from-blue-900 via-blue-700 to-blue-500 text-white px-6 pt-10 pb-6 relative shadow-inner"
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-30 text-sm">
        ...
        <div className="text-center md:text-left">
          <img
            ...
            alt="Subodh"
            className="w-35 h-35 rounded-full mx-auto md:mx-0 border-4 border-white mb-5 shadow-lg"
          />
          <Link
            to="/contact"
            className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-3 px-8 rounded-full shadow-md transition"
          >
            Hire Me
          </Link>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-200">
            <li className="flex items-center gap-2 hover:text-yellow-300 transition">
              ...
              <a href="mailto:subodh2073@gmail.com">subodh2073@gmail.com</a>
            </li>
            <li className="flex items-center gap-2 hover:text-yellow-300 transition">
      ...
      {/* Divider */}
      <div className="border-t border-purple-600   opacity-30" />
